      ...
      <main style={{ maxWidth: 1100, margin: '0 auto', padding: '12px 20px 70px', display: 'grid', gap: 28 }}>
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, justifyContent: 'center' }}>
            ...
            <p style={{ color: '#e5e7eb', lineHeight: 1.8 }}>
              Recognized by Forbes India’s Select200 list in 2024 and a member of the NVIDIA Inception Program, Cartoon Movie™ is quickly gaining global attention.
              Sekhar’s mission is clear: to democratize animation and empower anyone — from children, small creators and studios — to bring their imagination to life with the power of AI.
            </p>
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, justifyContent: 'center' }}>
            ...
            <p style={{ color: '#e5e7eb', lineHeight: 1.8 }}>
              As both Co-Founder and Strategic Lead, she plays a pivotal role in shaping the company’s vision — from forging partnerships and driving expansion to building a sustainable creator ecosystem.
            </p>
            <p style={{ color: '#e5e7eb', lineHeight: 1.8 }}>
              ...
              Sujana’s mission is to make Cartoon Movie™ a platform where creators, educators, and audiences worldwide can access limitless animated stories and opportunities.
            </p>
          </div>
        </section>
      </main>
