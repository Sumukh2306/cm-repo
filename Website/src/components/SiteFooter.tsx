...
//const appstore = require('../src/assets/appstore.png')
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              <a href="https://apps.apple.com/in/app/cartoon-movie/id6740822349" target="_blank" rel="noreferrer" style={{ display: 'inline-block' }}>
                <Image source={appStore} style={{ width: 160, height: 48 }} resizeMode="contain" />
                
                {/*<img src={ appStore } alt="Download on the App Store" style={{ width: 160, height: 48, objectFit: 'contain' }} />*/}
              ...
              <a href="https://play.google.com/store/apps/details?id=branded.mbdf5e8107dbf472ebfb530d38b681106.cartoonmovie&pcampaignid=web_share&pli=1" target="_blank" rel="noreferrer" style={{ display: 'inline-block' }}>
                <Image source={playStore} style={{ width: 160, height: 48 }} resizeMode="contain" />
                
                {/*<img src={ playStore } alt="Get it on Google Play" style={{ width: 160, height: 48, objectFit: 'contain' }} />*/}
